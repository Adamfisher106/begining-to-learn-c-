...
namespace tutorial_22_Events
{
    // events are used to trigger activities, in this case it trigers a PrintHelper. They can also be used to stop activities as well. :)
    ...
    //Arugments that can be used in congunction with events
